...
local function setup(configs)
   ...
   return {
      ...
      TSPunctDelimiter = { fg = colors.purple, },
      TSPunctBracket = { fg = colors.purple, },
      TSPunctSpecial = { fg = colors.purple, },
      ...
      rainbowcol5 = { fg = colors.bright_red, },
      rainbowcol6 = { fg = colors.white, },
